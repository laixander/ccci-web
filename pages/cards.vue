...
const avatars = [
    ...
    { src: 'https://avatar.iran.liara.run/public/86', alt: 'Mary Jane' },
    { src: 'https://avatar.iran.liara.run/public/36', alt: 'Oto Octavius' },
    { src: 'https://avatar.iran.liara.run/public/77', alt: 'Aunt May' },
];
