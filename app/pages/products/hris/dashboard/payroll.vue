    ...
    >
      ...
      <template #overview>
        <div class="space-y-6 pt-4">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <!-- Deductions -->
            <UCard title="Statutory Deductions">
              <div class="space-y-3">
      ...
      <template #run>
        <div class="pt-6 max-w-2xl mx-auto">
          ...
          <!-- Step 4: Done -->
          <UCard v-else-if="runStep === 4" :ui="{ body: 'text-center' }">
